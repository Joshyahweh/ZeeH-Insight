    ...
    <div>
      <main className="border rounded-lg">
        ...
        <div className="flex items-start justify-between mt-7 p-3 w-full text-gray-500 pr-24">
          ...
          <p>Marvin Companies</p>
          <p className="relative left-14">jessica.hn@example.com</p>
          <p className="relative left-12">(239) 555-0108</p>
          <p className="relative left-16">4517 Washington Ave.</p>
          <Box
            position="relative"
            left={20}
            gap="1.5rem"
...
export default ControlCustomer;
